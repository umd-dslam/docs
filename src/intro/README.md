...
All these questions will be addressed. This section will start with HDFS design architecture which leads to its limitations. Then we introduce a deterministic database to solve this problem.

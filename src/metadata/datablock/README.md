...
as NAS) etc. A storage in the Datanode is represented by this class. More information about DatanodeStorageInfo is covered by [Section 3.3 - DataNode Management](https://dsl-umd.github.io/docs/metadata/datanode/1.datanodeinfo.html#datanodestorageinfo)

...
- [HDFS Metadata Management](./metadata/README.md)
    - [Namespace Management](./metadata/namespace/README.md)
        - [FSDirectory](./metadata/namespace/1.fsdirectory.md)
        - [INode](./metadata/namespace/2.inode.md)
        - [File Operations](./metadata/namespace/3.fsop.md)
    - [Datablock Management](./metadata/datablock/README.md)
        - [Data Block](./metadata/datablock/1.datablock.md)
        - [Block and BlockInfo](./metadata/datablock/2.blockinfo.md)
        - [BlockManager](./metadata/datablock/3.blockmanager.md)
